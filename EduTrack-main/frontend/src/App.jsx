...
import AdminAllocateClasses from './pages/AdminAllocateClasses'
...
function AppContent() {
  return (
    <Routes>
      ...
      <Route path="/admin/home" element={<Navigate to="/admin/overview" replace />} />
      <Route path="/admin/dashboard" element={<Navigate to="/admin/overview" replace />} />
      <Route path="/admin/data" element={<Navigate to="/admin/overview" replace />} />
      <Route path="/admin/overview" element={<AdminOverview />} />
      <Route path="/admin/add-student" element={<AddStudent />} />
      <Route path="/admin/manage-students" element={<StudentManagementPage />} />
      <Route path="/admin/allocate-classes" element={<AdminAllocateClasses />} />
      <Route path="/admin/predict-risk" element={<Navigate to="/admin/overview" replace />} />
