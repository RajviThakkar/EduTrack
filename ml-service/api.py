...
def predict():
    ...
    computed = {
        'quiz_avg':       calculate_average_percent(data['quiz_scores'],       data['quiz_max']),
        'assignment_avg': calculate_average_percent(data['assignment_scores'], data['assignment_max']),
        'exam_avg':       calculate_average_percent(data['exam_scores'],       data['exam_max']),
        'attendance_pct': calculate_attendance_percent(data['classes_attended'], data['total_classes']),
    }

    features   = np.array([[computed['quiz_avg'], computed['assignment_avg'],
                             computed['exam_avg'], computed['attendance_pct']]])
